...
class LancamentosControllerTest < ActionController::TestCase
  ...
  test "should create lancamento" do
    assert_difference('Lancamento.count') do
      post :create, lancamento: { confirmado: @lancamento.confirmado, data: @lancamento.data, debito: @lancamento.debito, evento: @lancamento.evento, valor: @lancamento.valor }
    end
  ...
  test "should update lancamento" do
    put :update, id: @lancamento, lancamento: { confirmado: @lancamento.confirmado, data: @lancamento.data, debito: @lancamento.debito, evento: @lancamento.evento, valor: @lancamento.valor }
    assert_redirected_to lancamento_path(assigns(:lancamento))
  end
