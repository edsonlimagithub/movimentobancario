...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { descricao: @produto.descricao, descricao_sitef: @produto.descricao_sitef, prazo_id: @produto.prazo_id }
    end
  ...
  test "should update produto" do
    put :update, id: @produto, produto: { descricao: @produto.descricao, descricao_sitef: @produto.descricao_sitef, prazo_id: @produto.prazo_id }
    assert_redirected_to produto_path(assigns(:produto))
  end
