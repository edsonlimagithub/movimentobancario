...
class ContasControllerTest < ActionController::TestCase
  ...
  test "should create conta" do
    assert_difference('Conta.count') do
      post :create, conta: { descricao: @conta.descricao, inativo: @conta.inativo, limite: @conta.limite }
    end
  ...
  test "should update conta" do
    put :update, id: @conta, conta: { descricao: @conta.descricao, inativo: @conta.inativo, limite: @conta.limite }
    assert_redirected_to conta_path(assigns(:conta))
  end
